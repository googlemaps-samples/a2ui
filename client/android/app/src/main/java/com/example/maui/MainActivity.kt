...
import com.example.maui.ui.GroundingSourcesView
...
fun ChatScreen(viewModel: ChatViewModel, latencyLogger: LatencyLogger) {
  ...
  var selectedAgentType by remember { mutableStateOf(AgentType.LITE) }
    ...
    InputBar(
      ...
      onSend = {
        if (inputText.isNotBlank()) {
          viewModel.sendMessage(inputText, selectedAgentType, bypassCanned)
          inputText = ""
        }
      },
    )
